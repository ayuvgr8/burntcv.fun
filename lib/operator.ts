...
// (Terms, Privacy, Refund, Shipping, Contact) and the site footer, which
// Razorpay requires for merchant activation.
//
...
export const OPERATOR = {
  ...
  email: process.env.NEXT_PUBLIC_CONTACT_EMAIL ?? "ayuvgr8@gmail.com",
